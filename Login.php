...
if (isset($_POST['btnSubmit'])) {
    if (empty($_POST['txtUsername']) || empty($_POST['txtPassword'])) {
        $_SESSION['errorMessage'] = 'Xin hãy điền đầy đủ thông tin';
    } else {
...
<form class="form-signin" action="Login.php" method="post">
    ...
    <img class="mb-4" src="images/book.svg" alt="" width="72"
         height="72">
    ...
    <input type="password" id="inputPassword" class="form-control" name="txtPassword" placeholder="Mật khẩu" required>
